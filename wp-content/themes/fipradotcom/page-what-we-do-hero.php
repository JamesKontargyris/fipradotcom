...
<style>
    .with-hero-banner {
        background-image: url('<?php echo get_template_directory_uri(); ?>/img/people_1920x1000.jpg');
        background-position: top center;
        background-repeat: no-repeat;

    }
    .hero-banner-gradient {
        background-image: url('<?php echo get_template_directory_uri(); ?>/img/herobanner/hero-banner-overlay-dark-right.png');
        background-position: top center;
        background-repeat: no-repeat;
    }
</style>
...
<!--<div id="content-container">-->
    <div id="content-container" class="with-hero-banner">
        <div class="hero-banner-gradient dark">
                            ...
                            <div class="row-of-2">
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Jointly developing your Public Affairs action plan and objectives, clearly defining your strategic and tactical priorities.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Ensuring that your story effectively communicates your key messages and resonates with your target audiences.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Identifying the organisations and individuals that are relevant to your cause and helping you manage your contacts database.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Hands-on support to establish constructive dialogue with key stakeholders and effectively execute your action plan.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Tailored, in-depth analysis and assessment of political and regulatory developments at international, national and local levels.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Serving as your ‘eyes and ears’ on the ground to provide you with real-time intelligence and regular newsletters on key issues impacting your PA objectives.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Track record in leading and coordinating PA campaigns on the ground in over 60 countries, ensuring quality, consistency and timely delivery and execution.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Identifying the strengths and weaknesses of your Government Affairs practice through personalised recommendations.</p>
                                    </div>
                                    <div class="highlight-box secondary br-bottom">Contact <a href="#modal" rel="modal:open">Laura Batchelor</a> for more information.</div>
                                </div>
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Customised PA training sessions for your in-house policy and management personnel.</p>
                                    </div>
                                    <div class="highlight-box secondary br-bottom">Contact <a href="#modal" rel="modal:open">Dirk Hudig</a> for more information.</div>
                                </div>
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Crafting press statements that support your public policy objectives and helping you organise and prepare for press conferences and media appearances.</p>
                                    </div>
                                ...
                                <div class="showcase-block center bg shift-half-col">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Helping you understand what EU funds are available to your organisation and how to navigate the complex application process.</p>
                                    </div>
                                    <div class="highlight-box secondary br-bottom">Contact <a href="#modal" rel="modal:open">Peter-Carlo Lehrell</a> for more information.</div>
                                </div>
                            </div>
                            ...
                            <div class="row-of-3">
                                <div class="showcase-block center bg">
                                    <div class="showcase-block-content">
                                        ...
                                        <p class="no-margin">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Quisque a iaculis nisi. Phasellus et libero non quam tempor. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi.
                                    </div>
