...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <div id="content-container" class="<?= str_replace(' ', '-', strtolower(get_the_title())); ?> ep-election-analysis">
        ...
        <div class="ep-election-analysis-report-hero-container">
            ...
            <a href="<?php echo get_template_directory_uri(); ?>/files/fipra_pan_eu_election_analysis_email.pdf"><img class="ep-election-analysis-report-hero__report-cover" src="<?php echo get_template_directory_uri(); ?>/img/fipra-election-analysis-report-front-cover.jpg"></a>
...
<!--                <div class="ep-election-analysis-report-hero__content__skewed-background"> </div>-->
                ...
                <a href="<?php echo get_template_directory_uri(); ?>/files/fipra_pan_eu_election_analysis_email.pdf" class="btn primary btn-large btn-white ep-election-analysis-report-hero__button">Download the report</a>
