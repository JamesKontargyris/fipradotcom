            ...
            <div id="home-hero-carousel">
                ...
                <div class="hero hero-1">
                    <div class="full-width-block-container">
                        <div class="full-width-block-content-container dark-grey bg-image">
                ...
                <div class="hero hero-4">
                    <div class="full-width-block-container">
                        <div class="full-width-block-content-container faint-grey bg-image">
                        ...
                        <div class="showcase">
                            <div class="row-of-2">
                                ...
                                <div class="showcase-block">
                                    <a href="#" class="circle-icon small no-bottom-margin"><i class="icon-globe"></i></a>
                                    <div>
                            ...
                            <p class="center"><a class="btn primary btn-large" href="#">More Services and Expertise</a></p>
                        </div>
                    </div>
                </div>
            </div>
