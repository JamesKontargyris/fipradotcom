...
/*    Small and Medium Screens */
    #page-banner {
        background-image: linear-gradient(to bottom, rgba(125, 125, 125, 0) 90%, rgba(125, 125, 125, 0.15) 100%), url('<?php echo get_template_directory_uri(); ?>/img/fipriots/ukko_metsola.gif'), linear-gradient(to top, #EBEAE8 0%, white 50%);
    }
